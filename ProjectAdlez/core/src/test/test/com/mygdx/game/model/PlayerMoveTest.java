...
public class PlayerMoveTest {
    ...
    public void moveWithoutCollision() throws Exception {
        ...
        final float deltaT = 1/30;

        System.out.println("x0 " + player.getPosX());
        System.out.println("y0 " + player.getPosY());

        player.moveEast(deltaT);
        player.move(deltaT);
        System.out.println("x1 " + player.getPosX());
        System.out.println("y1 " + player.getPosY());
